        ...
        <section>
            ...
            <div class="mainpanel">
                ...
                <div class="contentpanel" id="contenido">
                    <jsp:include page="../formslab/frmpreparacion.jspf"></jsp:include>
                    <jsp:include page="../formslab/frmauxiliares.jspf"></jsp:include>
                </div><!-- contentpanel -->
            </div><!-- mainpanel -->
        </section>
        
        <!-- Modal -->
        <jsp:include page="../modales/modalMensajeAlert.jspf"></jsp:include>
